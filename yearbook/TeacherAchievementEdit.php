...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $query = "SELECT * FROM teacherachievements WHERE a_id='$id'";
...
if(isset($_POST["save"])) {
    ...
    { 
        ...
        $sql="UPDATE teacherachievements SET achievement='$a' WHERE a_id='$id'";
        if (mysqli_query($conn, $sql)) {
            echo "Record updated successfully";
           
            header('location:ViewAllTeachersAchievements(Admin).php');
