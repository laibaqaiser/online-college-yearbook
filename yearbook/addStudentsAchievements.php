...
if(isset($_POST["submit"])) {
    ...
    { 
        $id=mysqli_query($conn,"SELECT id FROM student WHERE userName ='$u'")->fetch_object()->id;
        $name=mysqli_query($conn,"SELECT fullName FROM student WHERE userName ='$u'")->fetch_object()->fullName;
        $sql="INSERT INTO studentachievements(id,fullName,RegNum,achievement) VALUES('$id','$name','$r','$a')";
        //$sql="UPDATE student SET achievement='$a' WHERE userName='$u'and regNum='$r'";
