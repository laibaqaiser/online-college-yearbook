    ...
    <body>
     ...
     if (!$conn) {
         die("Connection failed: " . mysqli_connect_error());
             ...
             if($type=="Student"){
                 $sql ="SELECT userName,fullName,regNum FROM student WHERE userName='$n' and password='$p'";
                        ...
                        <nav class="navbar navbar-expand-md sticky-top navbar-dark" id="customColor" >
                                ...
                                <div class="collapse navbar-collapse" id="navData">
                                    <ul class="navbar-nav ml-auto" >
                                            <li class="nav-item" >
                                                <a href="studentHome.html" class="nav-link" id="textColor">Home</a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        <div class="col-4 col-sm-4">
                                <div class="form-outer">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="input-container">
                                                <i class="fa fa-user icon"></i>
                                            <input type="text" name="regNo" placeholder="Registration Number" class="input-field"  value="<?php echo $regNum?>">
                                        ...
                                        <div class="input-container">
                                                <i class="fa fa-user icon"></i>
                                            <input type="text" name="gpa" placeholder="GPA" class="input-field">
                                            
                                        </div>
                                        <div class="input-container">
                                                <i class="fa fa-user icon"></i>
                                            <input type="text" name="cp" placeholder="Class Participation" class="input-field" >
                                            
                                        </div>
                                        <div class="input-container">
                                                <i class="fa fa-user icon"></i>
                                            <input type="text" name="cca" placeholder="Co Corricular Activities" class="input-field">
                                            
                                        </div>
                                        <div class="input-container">
                                                <i class="fa fa-user icon"></i>
                                            <input type="text" name="sports" placeholder="Sports" class="input-field">
