...
<?php
     ...
     if (!$conn) {
         die("Connection failed: " . mysqli_connect_error());
             ...
             if($type=="Teacher"){
                 $sql ="SELECT userName,fullName,regNum,section,dob,gender,nationality FROM teacher WHERE userName='$n' and password='$p'";
            ...
            Teacher Profile
                            ...
                            <div class="collapse navbar-collapse" id="navData">
                                    <ul class="navbar-nav ml-auto" >
                                            <li class="nav-item" >
                                                <a href="TeacherHome.php" class="nav-link" id="textColor"> Home</a>
                                            </li>
                                            <li class="nav-item" >
        ...
        <div class="container">
            <div class="row ">
                    <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <h1 class="text-left">Teacher Info</h1>
                            <div class="form-group">
                              ...
                              <div class="row" id="info">
                                ...
                                <div class="row" id="info">
                                  ...
                                  <div class="row" id="info">
                                      <div class="col-md-3" id="left-info">
                                          <label class="control-label col-sm-2" for="id_num">id</label>
                                      </div>
                                      <div class="col-md-9" id="right-info">
                                          <input type="text" class="form-control" id="id_num"  name="id_num" value="<?php echo $regNum?>">
                                      </div>
                                    </div>
