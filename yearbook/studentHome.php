           ...
           mysqli_close($conn);
             ...
             <div class="row" id="row" >
                  <div class="col-3">
                        <nav id="sidebar">
                                ...
                                <input type="text" class="form-control" id=i value="<?php echo $n ?>"></div>
                                    ...
                                    <ul class="list-unstyled components">
                                        ...
                                        <li><a href="ViewStudentAchievements.php">View Achievements</a></li>
                                        <li><a href="fellowAchievement.php">View fellow's Achievements</a></li>
                        ...
                        <div class="form-group"id="form">
                                <label for="societies & clubs ">Societies & Clubs</label>
                        </div>
               ...
               <div class="row">
                ...
                <div class="col-3">
                        <div class="card" style="width: auto;">
                                <img src="images/mechatronics.jpg" class="card-img-top" style="height:180px" >
                                <div class="card-body">
                                  <p class="card-text">Mechatronics Club</p>
                ...
                <div class= "col-3">
                        <div class="card" style="width: auto;">
                                <img src="images/sac.png" class="card-img-top" style="height:180px">
                                <div class="card-body">
                                  <p class="card-text">Soceity of Advancement & computing</p>
                ...
                <div class="col-3">
                        <div class="card" style="width: auto;">
                                <img src="images/scienceSociety.jpg" class="card-img-top" style="height:180px" >
                                <div class="card-body">
                                  <p class="card-text">Science Society</p>
               ...
               <div class="row" id="r">
                    ...
                    <div class="col-3">
                            <div class="card" style="width: auto;">
                                    <img src="images/blooddonor.jpg" class="card-img-top" style="height:180px">
                                    <div class="card-body">
                                      <p class="card-text">Blood Donor Society</p>
                                      <a href="#" class="btn btn-danger">Join</a>
                                    </div>
                    ...
                    <div class= "col-3">
                            <div class="card" style="width: auto;">
                                    <img src="images/uettribune.jfif" class="card-img-top" style="height:180px">
                                    <div class="card-body">
                                      <p class="card-text">Uet Tribune </p>
                    ...
                    <div class="col-3">
                            <div class="card" style="width: auto;">
                                    <img src="images/ehs.jpg" class="card-img-top" style="height:180px" id="nb" >
                                    <div class="card-body">
                                      <p class="card-text">Environmental and holiculture Society</p>
